...
[Реализация в проверенной версии, строка 189](https://github.com/mbob72/marc_parser/blob/8a67485d0337460020dd8d2084db81b321e0d010/src/marc-validator.ts?plain=1#L189). Это ссылка на код, а не замена документального основания.
