...
def catalog():
    ...
    return {
        ...
        'LD-02-Leader-19': ('Противоречие в источнике', [pdf(19, 'для позиции 19 нет кодов a, b, c'), pdf(33, '> b - Part with independent title\n> c - Part with dependent title')],
        ...
        'VF-G5': ('Подтверждено структурой MARC', [subfields],
